        ...
        [
            {
                ...
                "content": (
                    ...
                    "- Do NOT assume issues exist based on general knowledge — only report what the context confirms.\n"
                    "- If the context is insufficient to evaluate an area, say so rather than guessing.\n"
