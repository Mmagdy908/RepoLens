        ...
        [
            {
                ...
                "content": (
                    ...
                    "- Do NOT assume vulnerabilities exist based on general knowledge — only report what the context confirms.\n"
                    "- If the context is insufficient to assess a security area, say so rather than guessing.\n"
